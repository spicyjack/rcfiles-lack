...
" Last update:  Thu Nov 05 18:34:19 CET 1998
" ===================================================================
...
"       autoindent:  "off" as I usually do not write code.
  set   autoindent
"
"       "smart" indents, compliments autoindent
  set   smartindent
  set   nocindent
"       but disable the special indenting of comments in shell
  inoremap # X#
"
...
"       digraph:    required for those umlauts
  set   digraph
"
"       for typing in text in other languages
  set   encoding=utf-8
"
...
" set   highlight=8r,db,es,hs,mb,Mr,nu,rs,sr,tb,vr,ws
  set   highlight=8:,@:,db,es,hs,mb,Mr,nu,rs,sr,tb,vr,ws
"
...
"  set noignorecase
  set ignorecase
"       incsearch; search forward as you type in characters while
"       searching
  set incsearch
"       smartcase: if one character is capitalized, then search using
"       case-sensitivity
  set smartcase
"
...
"       Set up a nice highlighting for listchars
  highlight SpecialKey ctermbg=Blue ctermfg=Black guibg=#FFD9D9
  highlight NonText ctermbg=Blue ctermfg=Black guibg=#FFD9D9
  "highlight SpecialKey ctermbg=DarkBlue ctermfg=Grey guibg=#FFD9D9
  "highlight NonText ctermbg=DarkBlue ctermfg=Grey guibg=#FFD9D9

"       magic:       use some magic in search patterns?  Certainly!
  set   magic
"
"       match pairs of things to denote opening/closing of a block of
"       something
  set   matchpairs+=<:>,«:»,=:;
"
"       modeline:    ...
...
"               "$VIM/syntax" is where the syntax files are.
  set   path=.,$VIM/syntax/,/opt/local/share/vim/syntax
...
"       showmode:    Show the current mode?  YEEEEEEEEESSSSSSSSSSS!
  set   showmode
"
" the new and improved status line
  set   statusline=%(%-t\ %m%r%h%w%)%=Buf:%n\ %{&ff}\ %y\ [L%l,C%v]\ [%p%%]
...
"       writebackup:
  set nowritebackup
" count this many letters in the current file and then save
  set updatecount=20
" ===================================================================
" ABbreviations
" ===================================================================
...
" set the textwidth to 70 characters for replies (email&usenet)
  ...
  au BufNewFile,BufRead .letter,mutt*,nn.*,snd.* set nosmartindent
"
...
" run 'perl -c' (check file syntax) with the current file 
" %:p is explained in in the vim expand() function
  map ;c = :!perl -c %:p
"
"
" ===================================================================
...
" just load the main syntax file when Vim was compiled with "+syntax"
  if has("syntax")
    ...
    " Use my own syntax file on "mail/news messages":
      ...
      let myfiletypefile = "~/.vim/inc.vim"
...
" highlight long lines and whitespace on it's own line
autocmd FileType * highlight Comment term=bold cterm=bold ctermfg=Blue
autocmd FileType * highlight OverLength ctermbg=Blue ctermfg=Black guibg=#FFD9D9
"autocmd FileType * match OverLength /\%81v.\+\|^\s\+$/
autocmd FileType perl match OverLength /\%81v.\+\|^\s\+$\|\s\+$/
autocmd FileType perl :set list
"
autocmd FileType sh match OverLength /\%81v.\+\|^\s\+$\|\s\+$/
autocmd FileType sh :set list
"
autocmd FileType css match OverLength /\%81v.\+\|^\s\+$\|\s\+$/
autocmd FileType css :set list
"
autocmd FileType gitcommit :set textwidth=70
let g:sme_extlist = [ "c", "h", "py", "cc", "cpp", "hpp", "xml", "xslt", "vim", "pl" ]
let g:sme_filelist = [ "CMakeLists.txt", "vimrc" ]
"autocmd FileType mail highlight OverLength NONE
...
" set paste in Debian control files
  au BufNewFile,BufRead control set paste
